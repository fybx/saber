...
Bu dosyayı şu dillerde de okuyabilirsiniz: [English](https://github.com/adil192/saber/blob/main/README.md), [češtině](https://github.com/adil192/saber/blob/main/README-cs.md), [繁體中文](https://github.com/adil192/saber/blob/main/README-zh-TW.md), [Türkçe](https://github.com/adil192/saber/blob/main/README-tr.md)

Saber'in geliştiricisi olarak, sizi not alma şeklinizde devrim yaratan bir uygulamayla tanıştırmaktan heyecan duyuyorum. Saber, not alma deneyiminizi yeni zirvelere taşımak için tasarlanmış nihai el yazısı not alma uygulamasıdır! El yazısı sanatını keşfedin ve en son teknolojilerle desteklenen bu zengin özellikli uygulama ile yaratıcılığınızı ortaya çıkarın. Saber'ın sezgisel ve modern arayüzü not almayı, diyagramlar çizmeyi veya PDF'lere hassasiyetle açıklama eklemeyi zahmetsiz hale getiriyor.

Dijital notlar almaya başladığımda, gereksinimlerime uygun özel bir açık kaynak uygulaması bulamadım, bu yüzden tescilli bir uygulama kullanmak zorunda kaldım. İnsanlara güvenebilecekleri özel bir açık kaynak uygulama seçeneği sunmak için Saber'i yaratmaya karar verdim. Saber tamamen açık kaynaklıdır, yani herkes güvenli ve özel olduğundan emin olmak için kodu denetleyebilir. Saber verilerinizi şifreler ve seçtiğiniz herhangi bir uyumlu sunucuyla senkronize ederek verileriniz üzerinde tam kontrol sahibi olmanızı sağlar.

Tablette notlar alıp sonra bunları bilgisayarınıza aktarmayı mı tercih ediyorsunuz? Ya da belki de notlarınızı bir dizüstü bilgisayarda yazmayı ve ardından bir tablette yorum eklemeyi tercih ediyorsunuz? İş akışınız ne olursa olsun, Saber çoklu platform desteği ile notlarınıza istediğiniz zaman, istediğiniz yerden, istediğiniz cihazdan erişmenizi sağlar. Saber Android, iOS, Windows, macOS ve Linux'ta kullanılabilir ve notlarınız tüm cihazlarınız arasında otomatik olarak senkronize edilir.Ve eğer çevrim dışı iseniz, Saber tekrar çevrimiçi olduğunuzda notlarınızı otomatik olarak senkronize edecektir.

Saber şimdiye kadar kullandığınız en iyi dijital vurgulayıcıya sahiptir. Hiç birden fazla satırı vurgulamanız gerekti ama fosforlu kalemin üst üste binmesinden ve renk değiştirmesinden nefret ettiniz mi? Saber, üst üste binmeleri işlemek ve kalemin renk tutarlılığını korumak için gelişmiş grafik işleme kullanır ve size geleneksel kağıttan daha iyi bir fosforlu kalem deneyimi sunar.

Saber notlarınızı düzenli tutmak için ihtiyacınız olan her şeye sahiptir. İç içe klasör sayısında sınırlama olmaksızın dilediğiniz kadar klasör içinde klasör oluşturun.Ve bir not iç içe geçmiş bir klasörün derinliklerine gömülmüş olsa bile, en son notlarınız her zaman ana ekranda mevcut olduğundan ona kolayca erişebilirsiniz. Saber, karanlık moddayken notlarınızı akıllıca ters çevirebilir. Bu, düşük ışıklı ortamlarda rahatlatıcı ve uyumlu bir arayüz için resimleriniz de dahil olmak üzere tüm not alma deneyimini karanlık modda yaşayabileceğiniz anlamına gelir.

Saber ile düşüncelerinizi yakalamanın ve düzenlemenin yepyeni bir yolunu keşfedin.
İster öğrenci, ister profesyonel, ister yaratıcı bir zihin olun, Saber dijital el yazısı için güvenilir arkadaşınızdır. Şimdi indirin ve fikirlerinizin özgürce akmasına izin verin!
...
[![GitHub sürümü (en son çıkan)](https://img.shields.io/github/v/release/adil192/saber)](https://github.com/adil192/saber/releases/latest)
...
[![GitHub tüm sürümler](https://img.shields.io/github/downloads/adil192/saber/total?label=GitHub%20downloads)](https://github.com/adil192/saber/releases)
...
<details open>
<summary>Ekran görüntülerini göstermek/gizlemek için dokunun</summary>
...
Lütfen [#1 Saber ilerlemesi][progress] başlığına bakın.

## Kurulum

<details>
<summary>Kurulum rehberini göstermek/gizlemek için dokunun</summary>

#### Android

Seçenekler:

1. [Play Store][google_play]'dan indirin

2. [F-Droid][f-droid]'den indirin
   - F-Droid sürümleri Onyx'in [kapalı kaynak bağımlılıklarını](https://github.com/adil192/saber/issues/219) gerektirdiğinden Onyx Boost cihazlar için optimize edilmemiştir.

3. En son [sürümlerden][releases] `Saber_{versiyon}.apk` dosyasını indirin.

#### Linux

Seçenek 1 (önerilen):
[Flathub][flathub]'dan flatpak'i kurun: `flatpak --user install com.adilhanney.saber`.

Seçenek 2:
En son [sürümlerden][releases] `Saber-{versiyon}-x86_64.AppImage` dosyasını indirin,
`chmod +x Saber-*-x86_64.AppImage`, komutu ile çalıştırılır dosya izni verin ve çalıştırın.

Seçenek 3:
@soumyaDghosh sayesinde resmi olmayan bir [snap][snap] paketi mevcut.
